...
class FornursingCtr3 extends Controller
{
    public function printschedule2($id)
    {
        ...
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where ward_id = '".$id."' and is_thismonth = '1' and role_id != '12' order by lastname asc");
    ...
    {   
        ...
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '1' and role_id != '12' and ward_id = '".$id."' order by lastname asc");
        $fornursing2 = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '2' and role_id != '12' and ward_id = '".$id."' order by lastname asc");
        $users = Hpersonal::get();
        $wards = ward::orderby('ward_name', 'asc')->get();
        $currentward = ward::where('id', $id)->first();

        return view('nursing.nurselevel2.getward',compact(
            'date',
            'nursing',
            'nursing2',
            'fornursing',
    ...
    public function reportgenerator($id)
    {
        ...
        $mydata = DB::select("select top 1 * from jhay.intranet_user WHERE employeeid = '".Auth::user()->employeeid."'");
        $wards = ward::orderby('ward_name', 'asc')->get();
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '1' and role_id != '12' order by lastname asc");

        return view('nursing.nurselevel2.reportgenerator', compact(
            'id',
            'date2',
            'curdate1',
            'curdate2',
    ...
    public function appendnurse($id)
    {
        ...
        $currentward = ward::where('id', $id)->first();
        return view('nursing.nurselevel2.appendnurse', compact(
            'date',
            'nursing',
            'users',
            'wards',
    ...
    public function editschedule($id)
    {
        ...
        $currentward = ward::where('id', $id)->first();
        $wards = ward::orderby('ward_name', 'asc')->get();
        return view('nursing.nurselevel2.getwardedit', compact(
            'nursing',
            'nursing2',
            'currentward',
            'date',
    ...
    public function saveschedule(request $request)
    {
        ...
        return redirect('/nurse2/ward/'.$request->ward_id);
    }

    public function level2noward()
    {
        $date2 = DB::select("select getdate() as date");
        $date2 = date('d', strtotime($date2[0]->date));
        ...
        $notregistered = DB::select("SELECT * FROM jhay.intranet_fornursing as tb1 LEFT JOIN jhay.intranet_user as tb2 ON tb1.employeeid = tb2.employeeid where is_thismonth = '1' AND is_registered = '0' AND tb2.role_id != '12'");
        
        return view('nursing.nurselevel2.noward', compact(
            'hpersonal',
            'hpersonal2',
            'mydata',
            'date',
    ...
    public function nurse2list1()
    {
        ...
        return view('nursing.nurselevel2.nurselis1',compact(
            'fornursing',
            'wards',
            'hpersonal',
            'mydata',
    ...
    public function nurse2list2()
    {
        ...
        $mydata = DB::select("select top 1 * from jhay.intranet_user WHERE employeeid = '".Auth::user()->employeeid."'");
        $wards = ward::orderby('ward_name', 'asc')->get();
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '1' and role_id = '11' order by lastname asc");
        return view('nursing.nurselevel2.nurselist2',compact(
            'fornursing',
            'wards',
            'hpersonal',
            'mydata',
    ...
    public function print2list1()
    {
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '1' and role_id = '1' order by lastname asc");
        return view('nursing.nurselevel2.printlist1',compact(
            'fornursing'
            ));
    }

    public function print2list2()
    {
        $fornursing = DB::select("select * from jhay.intranet_user as tb1 join jhay.intranet_fornursing as tb2 on tb1.employeeid = tb2.employeeid join hpersonal as tb3 on tb3.employeeid = tb2.employeeid where is_thismonth = '1' and role_id = '11' order by lastname asc");
        return view('nursing.nurselevel2.printlist2',compact(
            'fornursing'
            ));
    }
    ...
    {   
        ...
        return view('nursing.nurselevel2.replaceward', compact(
            'id',
            'date2',
            'hpersonal',
            'mydata',
