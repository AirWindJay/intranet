...
<body>
    <div id="app">
        ...
        <a href="{{ url('/home') }}" class="d-print-none btn btn-danger">Intranet Home</a>
...
<footer class="d-print-none footer" style="align:right;"><b>INTRANET Developed by: (MIS)..........</b></footer>
</html>
