...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            <a href="/billing/dashboard"><button class="d-print-none btn btn-danger" style="width: 20%;">Go Back</button></a>
            <button onclick="printpage()" class="d-print-none btn btn-info" style="width: 20%;">PRINT PAGE</button>
            <H3>FROM: {{date('F d Y', strtotime($datefrom))}} - TO: {{date('F d Y', strtotime($dateto))}}</H3>
        </div>
        <div class="col-sm-6">

            <form method="POST" action="/billing/patients" enctype="multipart/form-data" class="d-print-none">
                @csrf
                {{-- <input id="disdate" type="date" class="form-control" name="disdate" value="{{date('Y-m-d', strtotime($date))}}" hidden>   --}}
                <input id="datefrom" type="date" class="form-control" name="datefrom" value="{{date('Y-m-d', strtotime($datefrom))}}"> 
                <input id="dateto" type="date" class="form-control" name="dateto" value="{{date('Y-m-d', strtotime($dateto))}}">  
                ...
                <select name="dept" id="dept" class="form-control">
                    @foreach ($depts as $dept)
                        @if ($dept->tsdesc == $dept2)
                            <option value="{{$dept->tsdesc}}" selected>{{$dept->tsdesc}}</option>
                        @else
                ...
                <input type="submit" class="btn btn-primary" value="FILTER" name="submit" style="width: 100%">
            </form>
