            ...
            <div id="tablesize">
                <table class="table">
                    ...
                    <tr align="center">
                                ...
                                @else
                                    @foreach($hpersonal2 as $user)
                                        @if($service->officerid == $user->employeeid)
                                            {{$user->lastname}}, {{$user->firstname}} {{$user->middlename}}
                                            @if($service->status == 2)
                                                <a href="/adminmyrequests/acknowledge/{{$service->id}}" style="width:100%; padding-top: 30px; padding-bottom: 30px; color:black; font-size:30px;" class="btn btn-success">Acknowledge</a>
                                            @endif
                                        @endif
                                    @endforeach
                                @endif
                            ...
                            <td>
                                <a href="/delete/service/{{$service->id}}" style="width:100%; padding-top: 30px; padding-bottom: 30px; color:black; font-size:30px;" onclick="return confirm('Delete Service?');" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
