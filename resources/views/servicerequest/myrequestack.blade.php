    ...
    <div>
        <div class="col-md-12">
            ...
            @foreach ($services as $service)
                <form method="POST" action="/myrequests/acknowledge/save" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input style="margin-left:25px" type="radio" name="timer" id="timer" value="0">Minute/s
                            <input style="margin-left:25px" type="radio" name="timer" id="timer" value="1">Hour/s
                            <input style="margin-left:25px" type="radio" name="timer" id="timer" value="2">Day/s
                            <input style="margin-left:25px" type="radio" name="timer" id="timer" value="3">Week/s
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                        <label class="col-form-label text-md-right">{{ __('Rate My Performance ') }}</label><br>
