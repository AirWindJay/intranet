...
<h1 align="center" style="font-family:georgia"><b>Reply To Message<b></h1>
<div class="container">
    <div>
        <div class="col-md-10">
            ...
            <form method="POST" action="/reply/save">
                ...
                <div class="form-group row">
                        <div class="col-md-6">
                            <input hidden id="employeeid" type="employeeid" class="form-control{{ $errors->has('employeeid') ? ' is-invalid' : '' }}" name="employeeid" value="{{$id}}" required>
                    ...
                    @if ($item->to_me == '1')
                        <tr style="border: 5px solid white">
                            <td style="width: 50%; background-color: darkcyan; padding: 10px 10px 10px 10px; border: 5px solid white; border-radius: 5px;">
                                FROM CLIENT:<br>({{$hpersonal2[0]->lastname}}, {{$hpersonal2[0]->firstname}} {{$hpersonal2[0]->middlename}})<br><br>{{$item->msg}}
                            </td>
