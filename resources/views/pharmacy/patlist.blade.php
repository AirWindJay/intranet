...
@section('content')
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <form method="POST" action="/pharmacy/patient" enctype="multipart/form-data">
                    @csrf
                    
                    <input type="text" id="hos_no" name="hos_no" hidden>
    ...
    <div id="medsModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <!-- Modal content-->
            <form action="/pharmacy/meds/save" method="POST" enctype="multipart/form-data">
                @csrf
                @if ($diff == '1')
                    <input type="text" id="diff" name="diff" value="{{$diff}}" hidden>
                    <input type="text" id="disdate" name="disdate" value="{{$dd}}" hidden>
                    
                @elseif ($diff == '2')
                    <input type="text" id="diff" name="diff" value="{{$diff}}" hidden>
                    <input type="text" id="hos_no" name="hos_no" value="{{$hos_no}}" hidden>
                @endif
                ...
                if(data != null)
                {
                    ...
                    data.forEach(element =>
                    {
                        template += '<tr>' +
                                ...
                                '<td>'+ element.qty +'</td>' +
                                '<td>'+ element.str +'</td>' +
                                '<td><input id="qtyintake['+index+']" name="qtyintake['+index+']" type="number" value="'+ element.qtyintake +'" required>'+
                                ...
                                '<td> <input id="time_frequency['+index+']" name="time_frequency['+index+']" type="number" value="'+ element.time_frequency +'" required></td>'+
                                '<td>';
